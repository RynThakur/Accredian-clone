...
export default function Hero() {
  ...
  return (
    <section className="pt-28 pb-16 md:pt-40 md:pb-24 bg-gradient-to-br from-blue-50 via-white to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-stretch">
          ...
          <div className="relative min-h-[550px] md:min-h-[600px] h-full w-full rounded-2xl shadow-2xl bg-white border border-gray-100 flex items-center justify-center p-12 group overflow-hidden">
            <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 rounded-full bg-blue-100 mix-blend-multiply filter blur-3xl opacity-60"></div>
            <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 rounded-full bg-purple-100 mix-blend-multiply filter blur-3xl opacity-60"></div>
